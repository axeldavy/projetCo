...
and func = {f_name : ident ; f_type : mtype ; f_arg : lvar list ; mutable f_lvar_size : int (*taille du tableau d'activation*) ; mutable f_result_pos : int (*position du résultat*)}	
