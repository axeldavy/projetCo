...
let func_end f =
  ...
  (*on positionne SP sur le r�sultat renvoy� par la fonction*)


(*fonction qui renvoie le type sous un pointeurs, utile pour les diff�rentes op�rations*)
...
let new_label = 
 ...
 (*charge dans reg ce qui est � adress. 
