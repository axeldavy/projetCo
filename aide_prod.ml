...
(* hypoth�se : les deux variables sont dans t0 et t1 et de types type1, type2*)
...
let prep_binop type1 type2 =
  ...
  | ( TPointer _ , TInt) | (TPointer _,TChar) 
      -> mips[Arith(Mips.Mul,T1,T1,Oimm(4))] (* rq: un code optimis� devrait faire un d�calage *)
...
let prep_unop type1 =
  ...
  | ( TPointer _ ) 
      -> mips[Arith(Mips.Mul,A0,A0,Oimm(4))] (* rq: un code optimis� devrait faire un d�calage *)
